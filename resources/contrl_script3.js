...
async function updateDropdowns() {
    ...
    if (data !== null) {
        ...
        // Update the second custom dropdown (Buc_self_master_layout)
        updateDropdown('Buc_self_master_layout', '1.3.6.1.4.1.29686.1.1.4.1.4.0', data);

         // Update the second custom dropdown (Buc_reboot_layout)
         updateDropdown('Buc_reboot_layout', '1.3.6.1.4.1.29686.1.1.4.1.4.0', data);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function perform_rfmuteset() {
        ...
        var set_ipAddress = "192.168.100.5";
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function performDigitalAttnSet(value) {
        const setCommunity = "private";
        const setIpAddress = "192.168.100.5";
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('rf_parameters_settings_card_text').style.color = 'grey';
    document.getElementById('system_settings_card_text').style.color = 'grey';
    document.getElementById('network_settings_card_text').style.color = 'green';
...
function operation_rpc()
{
    ...
    // document.getElementById('rf_parameters_settings_card_text').style.color = 'green';
    // document.getElementById('system_settings_card_text').style.color = 'grey';
    // document.getElementById('network_settings_card_text').style.color = 'grey';
...
function operation_ssc()
{
    ...
    // document.getElementById('rf_parameters_settings_card_text').style.color = 'grey';
    // document.getElementById('system_settings_card_text').style.color = 'green';
    // document.getElementById('network_settings_card_text').style.color = 'grey';
...
//===========================================================================
//  BUC SELF MASTER LAYOUT CHANGE BLOCK START
//===========================================================================


document.addEventListener('DOMContentLoaded', function() {
    var dropdownItems = document.querySelectorAll('#Buc_self_master_layout .dropdown-item');
    var dropdownButton = document.getElementById('Buc_self_master_layout_dropdownButton');
    var selectedValue = 'NA'; // Default value
    ...
    document.getElementById('buc_self_master_set_button').addEventListener('click', function() {
        perform_buc_self_master_set();
    });

    function perform_buc_self_master_set() {
        var set_community = "private";
        var set_ipAddress = "192.168.100.5";
        var set_oid = "1.3.6.1.4.1.29686.1.1.4.1.6.0";
        var set_value = selectedValue;
...
//===========================================================================
//  BUC SELF MASTER LAYOUT CHANGE BLOCK END
//===========================================================================


//===========================================================================
//  BUC REBOOT LAYOUT CHANGE BLOCK START
//===========================================================================


document.addEventListener('DOMContentLoaded', function() {
    var dropdownItems = document.querySelectorAll('#Buc_reboot_layout .dropdown-item');
    var dropdownButton = document.getElementById('Buc_reboot_layout_dropdownButton');
    var selectedValue = 'NA'; // Default value
    ...
    document.getElementById('buc_reboot_set_button').addEventListener('click', function() {
        perform_buc_reboot_set();
    });

    function perform_buc_reboot_set() {
        var set_community = "private";
        var set_ipAddress = "192.168.100.5";
        var set_oid = "1.3.6.1.4.1.29686.1.1.4.1.6.0";
        var set_value = selectedValue;
...
//===========================================================================
//  BUC REBOOT LAYOUT CHANGE BLOCK END
//===========================================================================


//===========================================================================
//===========================================================================
//  FETCH FOR THE NUMBER FIELDS
//===========================================================================
//===========================================================================
function fetchDataForNF() {
    fetch('write.txt')
        .then(response => response.text())
        .then(text => {
            ...
            const Digital_attn_NF = data['1.3.6.1.4.1.29686.1.1.4.1.3.0'] || 'NAN';
            // const oid2Value = data['1.3.6.1.4.1.29686.1.1.4.1.6.0'] || '0';
            
            // Display data in input fields
            document.getElementById('number-input').value = Digital_attn_NF;
            // document.getElementById('number2').value = oid2Value;
        })
        .catch(error => {
...
setInterval(fetchDataForNF, 10000); // 10000 milliseconds = 10 seconds
